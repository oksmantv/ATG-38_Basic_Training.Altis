...
GOL_AllowSpecialistGroundRoles = 1; // Dragon (Mortar), Light Rifleman, Ammo Bearer, Anti-Air, Asst. Heavy AT, Heavy AT
GOL_AllowSpecialistAirRoles = 1; // Para-Rescueman, Jet Pilot, Marksman
