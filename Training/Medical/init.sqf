...
MedicalAssessment = compile preprocessFileLineNumbers "Medical\MedicalAssessment.sqf";
MedicalAssessmentActions = compile preprocessFileLineNumbers "Medical\MedicalAssessmentActions.sqf";
...
// Assessment
[TerminalAssess_1, SpawnAssess_1] execVM "Medical\MedicalAssessmentActions.sqf";
